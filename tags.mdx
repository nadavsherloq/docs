...
<video autoPlay muted loop playsInline className="w-full aspect-video" src="/images/edittagfeature.mp4" />
...
<Note>To search for queries with specific assigned tags, learn more about the [search feature here](/search).</Note>
