...
title: 'Search'
---
Easily find the query you’re searching for and focus on what matters. <br></br>
Our search is compatible with all inputs—just write what you remember.

To quickly open the search, use the following keyboard shortcuts: <br></br>
Mac: `cmd` + `K` <br></br>
Windows: `ctrl` + `K`
...
<img src="/images/sherloq_search.png" 
   alt = "sherloq search"
   width="300" />
