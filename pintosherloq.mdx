...
<Steps>
  <Step title="Download Sherloq Plugin">
    Choose by your IDE:
    Datagrip (and Jetbrains tools) plugin, or cloud-based IDE.
  </Step>
  <Step title="Create an account">
    Using Google SSO or email.
  </Step>
  <Step title="Go to your IDE">
    And pin Sherloq extension to your screen.
  </Step>
   <Step title="Congratulations 🚀" icon='party-horn'>
    Yes, you did it! Now you can invite team members to join your Sherloq workspace. 
  </Step>
</Steps>

## So what now?
1. Import your exsiting saved SQL queries. Don't worry, we made it easy for you 😉
2. Create your first query 📄
3. Add it as a snippet and start save your time 🏃
