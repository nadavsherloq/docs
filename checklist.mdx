...
<Steps>
  <Step title="📌 Pin the plugin to your screen.">
    ...
    You can do it by tutorial [here](/pintosherloq).
  </Step>

  <Step title="🗂️ Import your existing saved SQL queries">
    Don't worry, we made it easy for you 😉
    You can do it [here](/importqueries).
  </Step>

  <Step title="🤝🏻 Invite team members to join your Sherloq workspace">
    Start creating the collaborative workspace in Sherloq. [Invite them](/invitesherloq) via the settings window. Once they log in, create and share the team folder with them.
  </Step>

  <Step title="📄 Save your first query ">
    You can do it by Sherloq or directly from your IDE. Use the AI feature to reduce your time. See more [here](/newquery).
  </Step>

  <Step title="🏃 Insert a query in your IDE">
    Add a query as a snippet and use it by typing `@@` in your editor. See more about it [here](/snippets). Start saving your time!
  </Step>
</Steps>
