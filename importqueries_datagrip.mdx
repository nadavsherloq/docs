...
<img
  src="/images/dg_import_files.png"
/>

<Steps>

<Step title = "Go to DataGrip and open files CMD+2 or ALT+2"> </Step>

<Step title = "Right click on the relevant folder -> Open in -> Finder/Location"> </Step>
...
<Step title = "Drag and drop the folder/files into the Upload a file in the Sherloq uploader "> 
 ...
 <Accordion title="Import from Datagrip console">
...
/>
   ...
   <Accordion title="Import Views queries">

<img
  src="/images/dg_import_views.png"
/>
...
<Step title = "Right click on the views folder -> Import/Export -> Export Data"> </Step>
...
<Step title = "Drag and drop the folder/files into the Upload a file in the Sherloq uploader "> 
 ...
 <Accordion title="Import files from queries history logs">
