...
3. **Public / Shared everyone in your company:** Anyone in your company (with the same email domain) can see this folder, including its subfolders and queries.

<img alt="Folder Permissions"
  width = "400px"
  src="/images/folders_type_zoom.png"/
  >
...
We know how to align permissions with your organization's needs. Let us know [here](https://tally.so/r/nWpzMv).