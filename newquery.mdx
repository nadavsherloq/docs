...
<Tip> You can also save queries directly from your IDE using the keyboard shortcut cmd/ctrl + shift + 9 </Tip>

Another convenient way to save queries is through the Sherloq "bubble" - a button that allows you to save directly from the editor.

You can choose to dismiss this feature based on your personal preferences.
...
<video
  ...
  src="/images/sherloq_save_from_editor.mp4"
></video>
